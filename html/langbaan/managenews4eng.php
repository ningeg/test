...
$delsql = "delete from newscenter4 where news_id='$HTTP_GET_VARS[news_id]'";
DBexec($Dbs,$delsql);
}
?>
<HTML><HEAD>
...
width=700 borderColorLight=#999999 border=1>
 ...
 $sql= "select * from newscenter4  where title_th like '%$HTTP_POST_VARS[text_search]%'";
				  }else{
...
if($bg =="#FFFFFF"){
  ...
  <TR class=font>
    ...
    <TD width="171">
      ...
      href="addnews4eng.php?news_id=<?=$arr[news_id]?>&edit=1"> 
