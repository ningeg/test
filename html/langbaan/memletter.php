...
for($a=0;$a<$rows2;$a++){
		...
		$custmail = $arr2[email];
									...
									$tomail = "$custmail";
									$headers = "From: webmaster@pd.co.th\n";
...
<TABLE cellSpacing=2 cellPadding=2 width="100%" border=0>
  ...
  <TR>
    <TD bgColor=#cccccc><STRONG 
      class=font>&nbsp;&nbsp;&nbsp;<span lang="th">ส่งจดหมายให้สมาชิก</span></STRONG></TD></TR></TBODY></TABLE>
  ...
  <TR class=font bgColor=#60aad2>
    ...
    <TD width="171">
     ...
     สถานะ <span lang="en-us">/ </span>แก้ไข &nbsp; /&nbsp;ลบ</DIV></TD></TR>
		...
		<?
	if($text_search){
 $sql= "select * from letter_tb  where title_th like '%$text_search%'";
				  }else{
...
if($bg =="#FFFFFF"){
  ...
  <TR class=font>
    ...
    <TD width="133">
      ...
      href="allmemberletter.php?news_id=<?=$arr[news_id]?>&send=1">ส่งจดหมาย</A></span></TD>
