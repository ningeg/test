...
if($_POST[Submit]){
$insert = "insert into newscenter13 set title_eng='$_POST[title_eng]',title_th='$_POST[title_th]',details_eng='$_POST[details_eng]',details_th='$_POST[details_th]',pic_s='$thumb1_name',pic_b='$picture1name',file_name='$_POST[file_name]',file_down='$picture2_name',ddpost='".date("YmdHis")."'";
DBexec($Dbs,$insert);
Header("Location:addnews13.php?news_id=00001&edit=1");

}
if($_POST[Update]&&$_POST[details_th]!=""){
$update = "update newscenter13 set title_eng='$_POST[title_eng]',title_th='$_POST[title_th]',details_eng='$_POST[details_eng]',details_th='$_POST[details_th]'";
if($picture1name){
...
<?
			if($_GET[news_id]){
			$sql = "select * from newscenter13  where  news_id='$_GET[news_id]'";
			  $res =  DBexec($Dbs,$sql);
			  $rows = DBNumrows($res);
