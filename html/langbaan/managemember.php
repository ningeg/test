...
$delsql = "delete from member where mem_id='$HTTP_GET_VARS[mem_id]'";
DBexec($Dbs,$delsql);
}
?>
<HTML><HEAD>
...
<TABLE cellSpacing=2 cellPadding=2 width="100%" border=0>
  ...
  <TR>
    <TD bgColor=#cccccc><STRONG 
      class=font>&nbsp;&nbsp;&nbsp;ราย<span lang="th">รายชื่อสมาชิก</span></STRONG></TD></TR></TBODY></TABLE>
...
width=700 borderColorLight=#999999 border=1>
  ...
  <TR class=font bgColor=#60aad2>
    <TD width="163" align="center">
      <span lang="th">ชือ - นามสกุล</span></TD>
...
if($bg =="#FFFFFF"){
  ...
  <TR class=font>
    <TD  >
      <DIV class=detalbody align=center><?=$arr[name]?> <?=$arr[lname]?> </DIV></TD>
   <TD   width="160">
      <DIV class=detalbody align=center><?=$arr[email]?></DIV></TD>
    <TD width="155">
      <DIV class=detalbody align=center>&nbsp;<A 
      href="memdetails.php?mem_id=<?=$arr[mem_id]?>&edit=1"> 
      รายละเอียด </A>&nbsp; /&nbsp;<A onclick='return checkdelete()'
      href="?mem_id=<?=$arr[mem_id]?>&del=1">ลบ</a></DIV></TD></TR>
  <? } ?>
