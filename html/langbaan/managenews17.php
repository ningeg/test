...
$delsql = "delete from newscenter17 where news_id='$HTTP_GET_VARS[news_id]'";
DBexec($Dbs,$delsql);
}
?>
<HTML><HEAD>
...
width=700 borderColorLight=#999999 border=1>
 ...
 $sql= "select * from newscenter17  where title_th like '%$HTTP_POST_VARS[text_search]%'";
				  }else{

	$sql = "select * from newscenter17  order by news_id  DESC";
}
  $res1 = DBexec($Dbs,$sql);
...
if($bg =="#FFFFFF"){
  ...
  <TR class=font>
    ...
    <TD width="171">
      ...
      href="addnews17.php?news_id=<?=$arr[news_id]?>&edit=1"> 
