...
$delsql = "delete from newscenter where news_id='$HTTP_GET_VARS[news_id]'";
DBexec($Dbs,$delsql);
}
?>
<HTML><HEAD>
...
<TABLE cellSpacing=2 cellPadding=2 width="100%" border=0>
  ...
  <TR>
    <TD bgColor=#cccccc><STRONG 
      class=font>&nbsp;&nbsp;&nbsp;ราย<span lang="th">การข่าวสาร</span></STRONG></TD></TR></TBODY></TABLE>
...
width=700 borderColorLight=#999999 border=1>
 ...
 $sql= "select * from newscenter  where title_th like '%$HTTP_POST_VARS[text_search]%'";
				  }else{

	$sql = "select * from newscenter  order by news_id  DESC";
}
  $res1 = DBexec($Dbs,$sql);
...
if($bg =="#FFFFFF"){
  ...
  <TR class=font>
    ...
    <TD width="171">
      ...
      href="addnews.php?news_id=<?=$arr[news_id]?>&edit=1"> 
     แก้ไข</A></DIV></TD></TR>
  <? } ?>
