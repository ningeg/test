...
\* ---------------------------------------------------------------------- */
function generate_wysiwyg(textareaID,objtbxWidth,objtbxHeight) {
	if(objtbxWidth!=''){
		 wysiwygWidth = objtbxWidth;
		 wysiwygHeight = objtbxHeight;
	}else{
		 wysiwygWidth = 450;
		 wysiwygHeight = 250;
	}
  ...
  toolbar =  '<table cellpadding="0" cellspacing="0" border="0" class="toolbar1" style="width:' + toolbarWidth + 'px;"><tr><td style="width: 6px;"><img src="' +imagesDir+ 'seperator2.gif" alt="" hspace="3"></td>';
	...
	toolbar += '<td style="width: 90px;"><span id="FontSelect' + n + '" class="toolbar1"></span></td>';
	toolbar += '<td style="width: 60px;"><span id="FontSizes'  + n + '" class="toolbar1"></span></td>';
...
function formatText(id, n, selected) {
  ...
  document.getElementById("wysiwyg" + n).contentWindow.focus();
	...
	if (viewTextMode == 1 && disabled_id == 1) {
      ...
      window.open(popupsDir + 'insert_image.php?category=general&action=view&wysiwyg=' + n,'popup','location=0,status=0,scrollbars=0,resizable=0,width=450,height=500');
	  }
