...
echo $_POST[details_th];
if($_POST[Submit]){
$insert = "insert into newscenter7 set title_eng='$_POST[title_eng]',title_th='$_POST[title_th]',details_eng='$_POST[details_eng]',details_th='$_POST[details_th]',pic_s='$thumb1_name',pic_b='$picture1name',file_name='$_POST[file_name]',file_down='$picture2_name',ddpost='".date("YmdHis")."'";
DBexec($Dbs,$insert);
Header("Location:managenews7.php");
}
if($_POST[Update]&&$_POST[details_th]!=""){
$update = "update newscenter7 set title_eng='$_POST[title_eng]',title_th='$_POST[title_th]',details_eng='$_POST[details_eng]',details_th='$_POST[details_th]'";
if($picture1name){
...
<?
			if($_GET[news_id]){
			$sql = "select * from newscenter7  where  news_id='$_GET[news_id]'";
			  $res =  DBexec($Dbs,$sql);
			  $rows = DBNumrows($res);
