...
$insert = "insert into newscenter4 set title_eng='$HTTP_POST_VARS[title_eng]',title_th='$HTTP_POST_VARS[title_th]',details_eng='$HTTP_POST_VARS[details_eng]',details_th='$HTTP_POST_VARS[details_th]',pic_s='$thumb1_name',pic_b='$picture1name',file_name='$HTTP_POST_VARS[file_name]',file_down='$picture2_name',ddpost='".date("YmdHis")."'";
DBexec($Dbs,$insert);
Header("Location:managenews4eng.php");
}
if($HTTP_POST_VARS[Update]){
$update = "update newscenter4 set title_eng='$HTTP_POST_VARS[title_eng]',title_th='$HTTP_POST_VARS[title_th]',details_eng='$HTTP_POST_VARS[details_eng]',details_th='$HTTP_POST_VARS[details_th]'";
if($picture1name){
...
<?
			...
			$sql = "select * from newscenter4  where  news_id='$HTTP_GET_VARS[news_id]'";
			  $res =  DBexec($Dbs,$sql);
			  $rows = DBNumrows($res);
