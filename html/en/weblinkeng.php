              ...
              <td><img src="../images/shadow_head.jpg" width="720" height="15" /><br />
                  <table width="100%" border="0" cellspacing="0" cellpadding="0">
                    <tr>
                      ...
                      <td width="667" height="33" align="left" valign="top" background="../images/wel2.jpg" class="bigWhite"><STRONG class="Topictext">&nbsp;&nbsp;&nbsp;&nbsp;<span class="NorTxtGray">Weblink</td>
                      <td align="left">&nbsp;</td>
                    </tr>
                </table></td>
            </tr>
                                ...
                                <td valign="top"><table width="100%" border="0" cellpadding="1" cellspacing="0" class="Black12">
                                  <tr>
                                    <td align="center"><?if($arr[l_logo]){?>
                                      <table width="100" border="0" cellpadding="2" cellspacing="0" class="borrr2">
                                        <tr>
                                          <td><a href="<?=$arr[l_url]?>" target="_blank"><img src="../picnews/thumb/<?=$arr[l_logo];?>" alt="<?=$arr[l_name]?>"  width="120" border="0" /></a></td>
                                        </tr>
                                      </table>
                                      <a href="<?=$arr[l_url]?>" target="_blank">        </a>
                                    <?=$arr[l_name];?></td><?}?>
                                  </tr>
                                </table></td>
                              </tr>
