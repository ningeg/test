      ...
      <td><table width="100%" border="0" cellspacing="0" cellpadding="0">
        <tr>
          ...
          <td valign="top" background="../images/bg_content.jpg"><table width="100%" border="0" cellspacing="0" cellpadding="0">
			...
			if($news_id){
			$sql = "select * from newscenter3  where  news_id='$news_id'";
			  $res =  DBexec($Dbs,$sql);
			  $rows = DBNumrows($res);
		...
		?>
                        <tr>
                          <td width="98%" height="25" align="left" valign="top"><table width="100%" border="0" align="center" cellpadding="0" cellspacing="0">
                            ...
                            <?
$sql4  = "select  * from  newscenter3  order by news_id  DESC limit 15";
						...
						?>
                            <tr>
                              <td width="18%" align="left" valign="top"><table width="80" border="0" cellpadding="0" cellspacing="3" class="borrr2">
                                  <tr>
                                    <td><a href="newdetails3.php?news_id=<?=$arr4[news_id];?>"><img  
                  src="../picnews/thumb/<?=$arr4[pic_s];?>" width="100"  align="left" border="0" /></a></td>
                                  </tr>
                                </table>
                                <a href="newdetails3.php?news_id=<?=$arr4[news_id];?>"  class="LinkTopicBack"></a></td>
                              <td width="82%" align="left" valign="top"><div id="hotnew"><a href="newdetails3.php?news_id=<?=$arr4[news_id];?>">
                                  <?if($arr4[pic_s]){?>
                                  </a>
                                      <?}?>
                                      ...
                                      <br />
                                        [ <a href="newdetails3.php?news_id=<?=$arr4[news_id];?>" class="linkOrange">More...</a> ]</span> </div></td>
                            </tr>
                            <tr>
