...
<div align="center">
  <table width="900" border="0" cellspacing="0" cellpadding="0">
              ...
              <td><img src="images/shadow_head.jpg" width="720" height="15" /><br />
                  <table width="100%" border="0" cellspacing="0" cellpadding="0">
                    <tr>
                      ...
                      <td width="667" height="33" align="left" valign="top" background="images/wel2.jpg" class="bigWhite"><STRONG class="Topictext">&nbsp;&nbsp;&nbsp;&nbsp;<span class="NorTxtGray">วิชาการ</td>
                      <td align="left">&nbsp;</td>
                    </tr>
                </table></td>
            </tr>
	...
	if($text_search){
 $sql= "select * from newscenter12  where title_th like '%$text_search%'";
				  }else{

	$sql = "select * from newscenter12 order by news_id  DESC";
}
  $res1 = DBexec($Dbs,$sql);
		...
		?>
                        <tr>
                          ...
                          <td width="98%" height="25" align="left" valign="top"><table width="100%" border="0" cellspacing="0" cellpadding="0">
                              <tr>
                                <td height="25"><span class="NorTxtGray"><strong><a href="newdetails12.php?news_id=<?=$arr[news_id];?>" class="TopicRed">
                                  <?=$arr[title_th];?>
                                </a></strong></span></td>
                              </tr>
                              <tr>
