...
<div align="center">
  <table width="900" border="0" cellspacing="0" cellpadding="0">
    ...
    <tr>
      <td><?php include("inc_menu2.php"); ?><table width="100%" border="0" cellspacing="0" cellpadding="0">
        <tr>
		...
		//	if($news_id){
		//	$sql = "select * from newscenter11  where  news_id='$news_id'";
			$sql = "select * from newscenter11";
			  ...
			  ?>
                ...
                <table width="100%" border="0" cellspacing="0" cellpadding="0">
                  <tr>
                    ...
                    <td width="667" height="33" align="left" valign="top" background="images/wel2.jpg" class="bigWhite"><STRONG class="Topictext">&nbsp;&nbsp;&nbsp;&nbsp;<span class="NorTxtGray"><?=$arr[title_th];?></td>  
                    <td align="left">&nbsp;</td>
                  </tr>
                </table></td>
            </tr>
