          ...
          <td valign="top" background="images/bg_content.jpg"><table width="100%" border="0" cellspacing="0" cellpadding="0">
              ...
              <td><img src="images/shadow_head.jpg" width="720" height="15" /><br />
                <table width="100%" border="0" cellspacing="0" cellpadding="0">
                  <tr>
                    ...
                    <td width="667" height="33" align="left" valign="top" background="images/wel2.jpg" class="bigWhite"><STRONG class="Topictext">&nbsp;&nbsp;&nbsp;&nbsp;<span class="NorTxtGray">ติดต่อเรา</td>
                    <td align="left">&nbsp;</td>
                  </tr>
                </table></td>
            </tr>
            <tr>
              <td><table width="90%" border="0" align="center" cellpadding="0" cellspacing="0">
                ...
                <tr>
                  <td valign="top"><p><span class="TopicRed">สมาคมปลูกถ่ายอวัยวะแห่งประเทศไทย </span><br />
                          <span class="Black12">อาคารเฉลิมพระบารมี 50 ปี ชั้น 4 เลขที่ 2  ซ.ศูนย์วิจัย ถ. เพชรบุรีตัดใหม่ บางกะปิ ห้วยขวาง กรุงเทพฯ 10310 <br />
                            โทร 02-716-6181  โทรสาร 02-716-6183 </span><br />
                      ...
                      <form action="sendmail.php" method="post" name="form1" id="form1">
                          <table width="100%"  border="0" cellpadding="0" cellspacing="0" class="gray13">
                            ...
                            <tr>
                              ...
                              <td align="right" valign="top" class="Black12">ชื่อ :&nbsp; </td>
                              <td align="left" class="Black12"><input name="name" type="text" id="name2" size="30" />
                                  <span class="font_3">*</span></td>
                            </tr>
                            <tr>
                              <td>&nbsp;</td>
                              <td align="right" valign="top" class="Black12">ที่อยู่ :&nbsp;</td>
                            ...
                            <tr>
                              <td>&nbsp;</td>
                              <td align="right" valign="top" class="Black12">โทรศัพท์ :&nbsp;</td>
                              <td align="left" valign="top" class="Black12"><input name="tel2" type="text" id="tel2" size="30" />
                                  <span class="font_3">*</span></td>
                            </tr>
                            <tr>
                              <td>&nbsp;</td>
                              <td align="right" valign="top" class="Black12">ข้อความ :&nbsp; </td>
...
?>
                                ...
                                &nbsp;&nbsp;<br />
                                โปรดกรอกตัวเลข <img src="images/0.gif" width="6" height="1" /></span></td>
                            </tr>
                            <tr>
                              <td>&nbsp;</td>
                              <td class="Black12">&nbsp;</td>
                            ...
                            <tr>
                              <td>&nbsp;</td>
                              <td class="Black12">&nbsp;</td>
                              <td align="left" class="Black12"><input type="submit" name="Submit3" value=" ส่ง " /></td>
                            </tr>
                          </table>
                      </form>
                      <p>&nbsp;</p>
