              ...
              <td><img src="images/shadow_head.jpg" width="720" height="15" /><br />
                  <table width="100%" border="0" cellspacing="0" cellpadding="0">
                    <tr>
                      ...
                      <td width="667" height="33" align="left" valign="top" background="images/wel2.jpg" class="bigWhite"><STRONG class="Topictext">&nbsp;&nbsp;&nbsp;&nbsp;<span class="NorTxtGray">งานประชุมวิชาการ</td>
                      <td align="left">&nbsp;</td>
                    </tr>
                </table></td>
            </tr>
		...
		?>
                        <tr>
                          ...
                          <td width="98%" height="25" align="left" valign="top"><table width="100%" border="0" cellspacing="0" cellpadding="0">
                              <tr>
                                <td height="25"><span class="NorTxtGray"><strong><a href="newdetails4.php?news_id=<?=$arr[news_id];?>" class="TopicRed">
                                  <?=$arr[title_th];?>
                                </a></strong></span></td>
                              </tr>
                              <tr>
